...
typedef struct _stritem {
    ...
    ///////////////////////////////
    uint8_t     is_dirty;   // when updated, this item is dirty and shall be flushed to SSD
                /// when being evicted
    unsigned char   key[MAX_KEY_LENGTH]; // assume the key is stored 
    unsigned long   pos_in_ssd;  // pos in SSD where this item sits
    void    *data; // memory where the real-value is stored
    ////////////////////////////////
